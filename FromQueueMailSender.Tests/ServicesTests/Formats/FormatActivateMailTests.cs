...
{
    public class FormatActivateMailTests
    {
        [Theory]
        ...
        public void GetContent_ForGivenName_ShouldContainsName(string name)
        {
            ...
            //act
            content = ActivateAccountContent.GetContent(name, "");
        ...
        public void GetContent_ForGivenUrl_ShouldContainsThreeUrls(string url)
        {
            ...
            //act
            content = ActivateAccountContent.GetContent("", url);
        ...
        public void GetContent_Always_ShouldContainsNoReplyPhrase()
        {
            ...
            //act
            content = ActivateAccountContent.GetContent(string.Empty, string.Empty);
